...
def test_action_uses_json_cli_contract() -> None:
    ...
    assert (
        "terraform-config|terraform-lock|terraform-state|terragrunt|cloudformation|cdk|azure|bicep|kubernetes|helm|kustomize|skaffold|devspace|tilt|cue|jsonnet|tanka|crossplane|serverless|sam|pulumi|pulumi-project|"
