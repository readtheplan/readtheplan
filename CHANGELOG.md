...
- Project auto-discovery now routes content-identified Crossplane, AWS SAM, Serverless Framework,
  ...
  treating Kubernetes-shaped formats as generic manifests. Canonical `.tfstate` files, stable
  Terraform/OpenTofu state JSON, and raw v4 snapshots now route to the value-safe state analyzer.
