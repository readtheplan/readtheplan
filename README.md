...
| Ansible project / inventory / execution environment | `readtheplan ansible-project execution-environment.yml` | Controller transport, privilege, plugins/callbacks, Galaxy dependencies, static/dynamic inventory, Builder images/dependencies/build commands, Navigator container isolation/mounts/environment, credentials, host trust, and execution boundaries |
