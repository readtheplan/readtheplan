...
Azure, Kubernetes, Cloudflare, Datadog, GitHub, GitLab, and HashiCorp Vault. Every adapter feeds the same six **compliance
...
|------|---------|----------------|
| Terraform / OpenTofu | `readtheplan analyze plan.json` | Structured plan diff plus AWS, GCP, Azure, Kubernetes, Cloudflare, Datadog, GitHub, GitLab, and HashiCorp Vault resource-aware rules |
...
- **Resource-aware rules** — first-party AWS, GCP, Azure, Kubernetes, Cloudflare, Datadog, GitHub, GitLab, and HashiCorp Vault semantics for identity, data, compute, networking, edge security, source governance, CI/CD trust, traffic, secrets, security, and observability
