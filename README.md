...
Azure, Kubernetes, Cloudflare, Datadog, GitHub, and GitLab. Every adapter feeds the same six **compliance
...
|------|---------|----------------|
| Terraform / OpenTofu | `readtheplan analyze plan.json` | Structured plan diff plus AWS, GCP, Azure, Kubernetes, Cloudflare, Datadog, GitHub, and GitLab resource-aware rules |
...
- **Resource-aware rules** — first-party AWS, GCP, Azure, Kubernetes, Cloudflare, Datadog, GitHub, and GitLab semantics for identity, data, compute, networking, edge security, source governance, CI/CD trust, traffic, security, and observability
