...
| Ansible project / inventory / execution environment / Molecule | `readtheplan ansible-project molecule/default/molecule.yml` | Controller transport, privilege, plugins/callbacks, Galaxy dependencies, static/dynamic inventory, Builder images/dependencies/build commands, Navigator isolation, and Molecule drivers/platforms/images/mounts/provider settings/scenario sequences/verifiers, with credentials, host trust, cleanup, and execution boundaries |
